...
function setup() 
{
  ...
  stardisplay = createSprite(65,40,60,60)
  stardisplay.scale = 0.25

  stardisplay.addAnimation('zerostars',zerostar)
  stardisplay.addAnimation('onestar',onestar)
  stardisplay.addAnimation('twostars',twostar)
  stardisplay.changeAnimation('zerostars')
